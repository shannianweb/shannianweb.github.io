(function () {
  ...
  var translations = {
    'zh-CN': {
      ...
      'download.desc': '手表端和移动端适合随时记录，桌面端适合整理、搜索和深度编辑。当前安装包版本为 1.0.23。',
      ...
      'download.card.windows.meta2': 'v1.0.23',
      ...
      'download.card.macos.meta2': 'v1.0.23',
      ...
      'download.card.linux.meta2': 'v1.0.23',
      ...
      'download-page.desc': '一个账号覆盖手表、手机与电脑。当前安装包版本为 1.0.23。下方提供各平台下载入口与首次安装说明。',
    ...
    en: {
      ...
      'download.desc': 'Watch and mobile for quick capture, desktop for organizing, searching, and deep editing. Current version: 1.0.23.',
      ...
      'download-page.desc': 'One account for watch, phone, and computer. Current version: 1.0.23. Find download links and first-time setup instructions below.',
